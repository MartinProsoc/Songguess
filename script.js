...
const USERNAME_DENYLIST = [
    // durva/trágár szavak (magyar) — a gyökér-alakok (pl. "bazd", "baszd") a ragozott
    // változatokat is elkapják (bazdmeg, baszdmeg, baszd meg, baszod, elbaszott, stb.),
    // mert a normalizálás előbb kiszedi a szóközöket/írásjeleket.
    'kurva', 'geci', 'picsa', 'fasz', 'buzi', 'koszfej', 'kocsog', 'faszfej', 'szopjal', 'anyad',
    'bazd', 'baszd', 'baszod', 'baszki', 'basztat', 'segg', 'pina', 'ribanc', 'kussolj',
    ...
    'fuck', 'shit', 'bitch', 'nigger', 'nigga', 'faggot', 'retard', 'whore', 'slut',
    'rape', 'nazi', 'hitler', 'cunt', 'asshole', 'dick', 'pussy', 'bastard'
];
