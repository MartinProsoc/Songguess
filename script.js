...
// ==========================================
// 3b. FIÓK / BEJELENTKEZÉS / FELHŐ-SZINKRON
// ==========================================
...
leaderboardBtn.addEventListener('click', async () => {
    ...
    if (!firestoreDb) {
        leaderboardList.innerHTML = '<p class="auth-error-msg mt-3">A ranglista betöltéséhez Firebase kapcsolat szükséges.</p>';
        return;
    }
